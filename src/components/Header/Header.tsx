    ...
    <header className="fixed inset-x-0 top-0 z-10 bg-color-2 dark:bg-color-4">
      <div className="flex h-20 items-center justify-between gap-5 border-b bg-color-2 p-5 text-base dark:bg-color-4">
        ...
        <div className="flex gap-5">
          <div
            data-sidebar={navBar}
            className="absolute -left-60 top-0 flex h-svh w-60 flex-col justify-between border-r bg-color-2 p-5 duration-200 data-[sidebar=true]:left-0 dark:bg-color-4 md:static md:h-auto md:w-fit md:border-none md:bg-transparent md:p-0 dark:md:bg-transparent"
          >
            <nav>
        ...
        <div className="flex gap-2">
          ...
          <DropDown.Root
            ...
            onClick={handleThemMenu}
          >
            <DropDown.Menu animation={themeMenu}>
              <DropDown.Option
                leftIcon={<Sun />}
                onClick={() => setTheme("light")}
              >
