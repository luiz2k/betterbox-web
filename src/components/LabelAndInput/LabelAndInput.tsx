    ...
    return (
      <div className="flex h-[4.5rem] flex-col space-y-0.5">
        ...
        <input
          ...
          className="rounded border border-color-3 bg-color-2 px-1 text-color-4 shadow-inner data-[error=true]:border-red-500 data-[success=true]:border-green-500 dark:focus:bg-white/80"
          {...props}
        />
